...
if "notification" in settings.INSTALLED_APPS:
    ...
    def create_notice_types(app, created_models, verbosity, **kwargs):
        notification.models.NoticeType.objects.create(label="user_follow", display=_("User following you"), description=_("another user has started following you"),default=0)
