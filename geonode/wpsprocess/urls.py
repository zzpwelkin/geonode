...
urlpatterns = patterns('geonode.wpsprocess.views',
    url(r'^(?P<provider>[_\w]+?)/wps/$', 'wps_global_dispatch', name='wps_global_dispatch' ),
    ...
    url(r'^update/$', UpdateProfileView.as_view(template_name='update_process_file.html'), name='update_profile'),                   
)
